...
@cruser.cru_cmd(
    pattern="الازرات(?:\s|$)([\s\S]*)",
    command=("الازرات", plugin_category),
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [cruserbot]<buttonurl:https://t.me/cr_source:same> [support]<buttonurl:https://t.me/gro_up_1>",
    },
)
async def _(event):
...
@cruser.cru_cmd(
    pattern="انلاين(?:\s|$)([\s\S]*)",
    command=("انلاين", plugin_category),
    info={
        ...
        "examples": "{tr}ibutton test <media:downloads/thumb_image.jpg> [google]<buttonurl:https://www.google.com> [cruserbot]<buttonurl:https://t.me/q_k_2:same> [support]<buttonurl:https://t.me/cr_source>",
    },
)
async def _(event):
