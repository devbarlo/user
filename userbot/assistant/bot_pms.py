    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"Hey! 👤{mention},\
                        ...
                        \n\nPowered by [cruserbot](https://t.me/cr_source)"
        buttons = [
            (
                Button.url("dev", "dr_criss"),
                Button.url(
                    "support",
                    "https://t.me/gro_up_1",
                ),
...
@cruser.cru_cmd(incoming=True, func=lambda e: e.is_private)
...
@cruser.cru_cmd(pattern="^/uinfo$", from_users=Config.OWNER_ID)
...
@cruser.cru_cmd(incoming=True, func=lambda e: e.is_private)
@cruser.cru_cmd(edited=True, func=lambda e: e.is_private)
